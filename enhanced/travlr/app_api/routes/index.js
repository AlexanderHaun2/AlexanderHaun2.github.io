...
router
    ...
    .post(authenticateJWT, requireRole('admin'), validateTrip, tripsController.tripsAddTrip); // POST Method Adds a Trip

// Get Method routes tripsFindByCode - requires parameter
router
    .route('/trips/:tripCode')
    .get(tripsController.tripsFindByCode)
    .put(authenticateJWT, requireRole('admin'), validateTrip.validateTripUpdate, tripsController.tripsUpdateTrip);
